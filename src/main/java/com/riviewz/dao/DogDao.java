...
public interface DogDao extends JpaRepository<Dog, String> {
	...
	List<BaseModel> findAllDogByCategory(String category);
	
	Dog findCounterById(int entityFk);
	
	@Modifying
	@Query(value="UPDATE dog_list SET counter = :counter WHERE id = :entityFk", nativeQuery = true)
